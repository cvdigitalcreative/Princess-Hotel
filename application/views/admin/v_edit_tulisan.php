    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Post Detail Room</h3>
        </div>
		<?php
        $b=$data->row_array();
    ?>
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Info Room</h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Album</label>
                <select class="form-control select2" name="xalbum" style="width: 100%;">
                  <option value="">-Pilih-</option>
                  <?php
              ...
              <!-- /.form group -->
			    <div class="form-group">
                <label>Harga</label>
                <input type="text" name="xharga" class="form-control" placeholder="Harga" value="<?php echo $b['tulisan_harga'];?>" />
              </div>
            <!-- /.box-body -->
          </div>
        </div>
