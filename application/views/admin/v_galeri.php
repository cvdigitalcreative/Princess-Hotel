                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <textarea name="xdeskripsi" class="form-control" id="inputUserName" placeholder="deskripsi foto"></textarea>
                                        </div>
                                    </div>
                                ...
                                <input type="hidden" value="<?php echo $galeri_gambar;?>" name="gambar">
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Deskripsi</label>
                                        <div class="col-sm-7">
                                          <textarea name="xdeskripsi" class="form-control" id="inputUserName" placeholder="deskripsi foto"><?php echo $galeri_deskripsi;?></textarea>
                                        </div>
                                    </div>
