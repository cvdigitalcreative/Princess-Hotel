      ...
      <ul class="sidebar-menu ">
        ...
        <li class="treeview <?php echo $cek2?>">
          ...
          <ul class="treeview-menu">
            <!-- <li><a href="<?php echo base_url().'Admin/Kategori'?>"><i class="fa fa-list"></i> Kategori</a></li> -->
            <li><a href="<?php echo base_url().'Admin/Tulisan'?>"><i class="fa fa-list"></i> List Tulisan</a></li>
            <!-- <li><a href="<?php echo base_url().'Admin/Tulisan/add_tulisan'?>"><i class="fa fa-thumb-tack"></i> Post Home</a></li> -->
          </ul>
        </li>
