            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <div class="room-slider-wrapper">
                            <div class="room-slider">
                                <?php foreach ($neoPCevent->result() as $row): ?>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="sidebar-widget" style="width: 317px;height: 350px">
                            <h3>Instagram</h3>
                            <!-- SnapWidget -->
                            <iframe src="https://snapwidget.com/embed/537582" class="snapwidget-widget" allowTransparency="true" frameborder="0" scrolling="no" style="border:none; overflow:hidden; width:275px; height:285px"></iframe>
                        </div>
