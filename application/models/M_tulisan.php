...
class M_tulisan extends CI_Model{
	...
	function simpan_tulisan($judul,$isi,$harga,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$gambar,$slug){
		$hsl=$this->db->query("INSERT into tbl_tulisan(tulisan_judul,tulisan_isi,tulisan_harga,tulisan_kategori_id,tulisan_kategori_nama,tulisan_album_id,tulisan_album_nama,tulisan_pengguna_id,tulisan_author,tulisan_gambar,tulisan_slug) values ('$judul','$isi','$harga','$kategori_id','$kategori_nama','$album_id','$album_nama','$user_id','$user_nama','$gambar','$slug')");
		return $hsl;
	}
	...
	function update_tulisan($tulisan_id,$judul,$isi,$harga,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$gambar,$slug){
		$hsl=$this->db->query("UPDATE tbl_tulisan set tulisan_judul='$judul',tulisan_isi='$isi',tulisan_harga='$harga',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_album_id='$album_id',tulisan_album_nama='$album_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_gambar='$gambar',tulisan_slug='$slug' where tulisan_id='$tulisan_id'");
		return $hsl;
	}
	function update_tulisan_tanpa_img($tulisan_id,$judul,$isi,$harga,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$slug){
		$hsl=$this->db->query("UPDATE tbl_tulisan set tulisan_judul='$judul',tulisan_isi='$isi',tulisan_harga='$harga',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_album_id='$album_id',tulisan_album_nama='$album_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_slug='$slug' where tulisan_id='$tulisan_id'");
		return $hsl;
	}
